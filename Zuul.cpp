...
void createRooms(ZuulRoom** zuulRooms) {//creates rooms and adds them to zuulRooms array
	...
	std::cout << "Test!" << std::flush;//SEG FAULT BEFORE HERE
